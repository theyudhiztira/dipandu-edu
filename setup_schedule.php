...
<html>
    <head>
        ...
        ?>
        <meta charset="UTF-8">
        <title>DiPandu Smart > Setup Schedule : <?php echo $_SESSION['core']['username']; ?></title>
    </head>
                ...
                <div class="col s12 m12 l12 advanced-search-box" style="padding: 0px !important;">
                    ...
                    <div class="col s12 m12 l12" style="margin-top: 10px;">
                        ...
                        <div class="col s12 m12 l12 input-field">
                            ...
                            <label>Classroom ( Leave it blank if no data available )</label>
                        </div>
    ...
    <script type='text/javascript' src='js/setup_schedule.js'></script>  
    </body>
</html>
